...
<head>
  ...
  <title>Sneakers Jakarta Store | Registration</title>
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <form  method="POST" action="{{ route('register') }}">
        ...
        <div class="input-group mb-3">
          <input type="number" class="form-control @error('no_telepon') is-invalid @enderror" placeholder="Nomor Telepon"  name="no_telepon" value="{{ old('no_telepon') }}" required autocomplete="no_telepon">
          <div class="input-group-append">
            <div class="input-group-text">
