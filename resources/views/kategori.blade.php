                    ...
                    <table id="kategoriTable" class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <!-- Tombol Edit -->
                                <button class="btn btn-sm bg-warning" data-toggle="modal" data-target="#editModal{{ $kategori->id }}">
                                    <i class="fas fa-edit"></i>
                                </button>
                            </td>
                            <td class="text-center">
                                <form action="{{ route('kategori.destroy', $kategori->id_kategori) }}" method="POST" onsubmit="return confirm('Apakah anda yakin ingin menghapus data ini?')">
                                    @csrf
                                    @method('DELETE')
